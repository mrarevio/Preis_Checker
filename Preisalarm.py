...
with tab3:
    ...
    if not df_5070ti.empty or not df_5080.empty:
        ...
        # Beispiel für die Preisentwicklung - Hier können Sie Grafiken hinzufügen
        st.subheader("Zukunftsprognose")
        # Hinweis: Fügen Sie hier Ihre Preisprognose-Logik und Grafiken hinzu
    else:
