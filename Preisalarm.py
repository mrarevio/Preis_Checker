...
with tab1:
    ...
    speichere_tagesdaten(daten_5070ti, os.path.join(DATA_DIR, "preise_5070ti.json"))  # Preis speichern
    df_5070ti = lade_daten(os.path.join(DATA_DIR, "preise_5070ti.json"))  # Laden der Preisdaten
...
with tab2:
    ...
    for name, url in produkte_5080.items():
        ...
        time.sleep(2)  # Pause hinzufügen
    speichere_tagesdaten(daten_5080, os.path.join(DATA_DIR, "preise_5080.json"))  # Preis speichern
    df_5080 = lade_daten(os.path.join(DATA_DIR, "preise_5080.json"))  # Laden der Preisdaten
